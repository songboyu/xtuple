...
/*
 * $Header: /home/cvs/jakarta-commons/httpclient/src/java/org/apache/commons/httpclient/ChunkedInputStream.java,v 1.22 2004/04/18 23:51:34 jsdever Exp $
 * $Revision: 1.22 $
 * $Date: 2004/04/18 23:51:34 $
 *
 * ====================================================================
 *
 ...
 *
 */
public class MyChunkedInputStream extends InputStream {
    ...
    private static final Log LOG = LogFactory.getLog(MyChunkedInputStream.class);
    /**
     *
     *
    ...
    public int read() throws IOException {
        ...
        if (pos >= chunkSize) {
            nextChunk();
            System.out.println("Over next chunk!");
            if (eof) { 
                return -1;
            }
        }
    ...
    private static int getChunkSizeFromInputStream(final InputStream in) 
      throws IOException {
        ...
        int b = in.read();
        String temp = "" + (char)b;
        System.out.println(StringEscapeUtils.escapeJava(temp) + "----" + b);
            if (b == -1) { 
